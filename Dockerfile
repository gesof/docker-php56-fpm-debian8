...
#docker run -d --name php56-fpm -p 9001:9000 gesof/docker-php56-fpm-debian8

docker run -d --name php56-fpm -p 9001:9000 --mount type=bind,source=/Users/alexjorj/yp/localserver.juristoffice.ro/,target=/Users/alexjorj/yp/localserver.juristoffice.ro/ -v "$PWD/php-fpm.ini":/etc/php5/fpm/php.ini -v "$PWD/php-cli.ini":/etc/php5/cli/php.ini gesof/docker-php56-fpm-debian8

docker run -d --name php56-fpm -p 9001:9000 --mount type=bind,source=/Users/alexjorj/yp/localserver.juristoffice.ro/,target=/Users/alexjorj/yp/localserver.juristoffice.ro/ -v /tmp/mysql.sock:/var/run/mysqld/mysqld.sock gesof/docker-php56-fpm-debian8
